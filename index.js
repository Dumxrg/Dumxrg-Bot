          ...
          case "/sticker":
            try {
              if (msg.hasMedia) {
                ...
                if (media && (media.mimetype.startsWith("image") || media.mimetype.startsWith("gif"))) {
                  // Add metadata for author and description
                  await client.sendMessage(msg.from, media, {
                    sendMediaAsSticker: true,
                    stickerAuthor: "★Dumxrg★",
                    stickerName: "Sticker created with the command /s\nUsing - Dumxrg bot",
                  });
                } else {
                  await msg.reply("La media recibida no es una imagen ni un gif.");
                }
              } else {
                ...
                if (
                  ...
                  if (media) {
                    ...
                    await msg.reply("No se pudo descargar el contenido multimedia.");
                  }
                } else {
                  await msg.reply(
